...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    config: {
      ...
      searchMaxDecomposedQueries: config.searchMaxDecomposedQueries,
      searchMinChunksPerCategory: config.searchMinChunksPerCategory,
      searchCategoryMinSimilarity: config.searchCategoryMinSimilarity,
