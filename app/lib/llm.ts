...
export function getConfig() {
  return {
    ...
    searchMaxDecomposedQueries: parseInt(process.env.SEARCH_MAX_DECOMPOSED_QUERIES || '10', 10),
    searchMinChunksPerCategory: parseInt(process.env.SEARCH_MIN_CHUNKS_PER_CATEGORY || '2', 10),
    searchCategoryMinSimilarity: parseFloat(process.env.SEARCH_CATEGORY_MIN_SIMILARITY || '0.075'),
